...
from ..transformer.adaln import AdaLayerNormSingle
from ..transformer.modality import Modality
from ..transformer.rope import (
    LTXRopeType,
    generate_freq_grid_np,
    generate_freq_grid_pytorch,
    precompute_freqs_cis,
)
from ..transformer.text_projection import PixArtAlphaTextProjection
...
class TransformerArgsPreprocessor:
    ...
    def prepare(
        ...
        # print("Preprocessing modality:", modality.latent.shape) 
        # print("Preprocessing modality:", modality.latent.device)#reprocessing modality: torch.Size([1, 4224, 128]) #Preprocessing modality: torch.Size([1, 84, 128])
        # try:
        #     print(self.patchify_proj.weight.shape, self.patchify_proj.bias.shape,)
        #     print(self.patchify_proj.weight.device, self.patchify_proj.bias.device,)#torch.Size([4096, 128])
        # except:
        #     pass
