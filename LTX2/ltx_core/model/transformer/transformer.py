...
from ..transformer.attention import Attention, AttentionCallable, AttentionFunction
from ..transformer.feed_forward import FeedForward
from ..transformer.rope import LTXRopeType
from ..transformer.transformer_args import TransformerArgs
...
class BasicAVTransformerBlock(torch.nn.Module):
    ...
    def forward(  # noqa: PLR0915
        ...
        run_a2v = run_vx and (audio is not None  and ax.numel() > 0) #0108  PR
