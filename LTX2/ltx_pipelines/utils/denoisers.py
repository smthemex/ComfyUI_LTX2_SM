...
from .helpers import modality_from_latent_state
...
def _guided_denoise(  # noqa: PLR0913
    ...
    *,
    ...
    _pass_ = tuple[str, torch.Tensor | None, torch.Tensor | None, PerturbationConfig]
    ...
    all_v, all_a = transformer(
        video=batched_video, audio=batched_audio, perturbations=BatchedPerturbationConfig(ptb_configs),gpu_manager=gpu_manager
    )
...
class SimpleDenoiser:
    ...
    def __call__(
        ...
        return transformer(video=pos_video, audio=pos_audio, perturbations=None,gpu_manager=gpu_manager)
